...
class StarSelector(ButtonsMixin, MplMultiTab):
    ...
    def __init__(self, filelist, coord_fns=None, offsets=None, show_blend=0):
        ...
        for i, filename in enumerate(filelist):
            ...
            api = ApertureInteraction( i, self.figures[i], plot_fits=True )
...
class Phot(object):
    ...
    def set_params(self, api):
        ...
        photpars.apertures = gen_phot_ap_radii( api.r_max_phot )       #List of aperture radii in scale units
