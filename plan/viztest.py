# coding: utf-8
from collections import OrderedDict, Callable, UserList
...
#@persist_to_file(coordinate_cache)
def resolver(name):
...
def sortmore(*args, **kw):
    ...
    if not isinstance(globalkey, Callable):
...
#         self.yaxis.set_tick_params('minor', labelsize=6, pad=5)
        ...
        self.xaxis.set_minor_locator(ticker.AutoMinorLocator())
        self.xaxis.set_major_formatter(AutoDateFormatter(dloc))
        
        self.yaxis.set_minor_locator(ticker.AutoMinorLocator())
